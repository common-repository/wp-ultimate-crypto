...
var Core;!function(e){!function(e){!function(e){var t=function(){function e(e){this.wrapper=e,this.input=e.find("input[type=hidden]"),this.infotext=e.find(".mabel-mc-chosen em"),this.init()}return e.prototype.init=function(){this.values=this.input.val().split(";"),this.setSelectedValues(),this.initAddToValues(),this.initRemoveFromValues()},e.prototype.setSelectedValues=function(){var e=this;this.wrapper.find(".mabel-mc-choice").not(".mc-choice-always-on").remove(),this.wrapper.find(".mabel-mc-option").each(function(t,i){var n=jQuery(i);jQuery.inArray(n.data("id").toString(),e.values)>-1&&(n.css("opacity",.6),e.createChosenOption(n.data("id"),n.html()),e.infotext.hide())})},e.prototype.initAddToValues=function(){var e=this;this.wrapper.find(".mabel-mc-option").off("click").on("click",function(t){t.preventDefault();var i=jQuery(t.currentTarget),n=i.data("id").toString();if(!(jQuery.inArray(n,e.values)>-1)){var a=i.html();e.values.push(n),e.input.val(e.values.join(";")),e.infotext.hide(),i.css("opacity",.6),e.createChosenOption(n,a),e.input.trigger("change")}})},e.prototype.initRemoveFromValues=function(){var e=this;this.wrapper.off("click",".mabel-mc-choice"),this.wrapper.on("click",".mabel-mc-choice",function(t){t.preventDefault();var i=jQuery(t.currentTarget);if(!i.hasClass("mc-choice-always-on")){var n=i.data("id").toString();e.wrapper.find(".mabel-mc-option[data-id="+n+"]").css("opacity",1),i.remove(),e.values.splice(e.values.indexOf(n),1),e.values.length||e.infotext.show(),e.input.val(e.values.join(";")),e.input.trigger("change")}})},e.prototype.createChosenOption=function(e,t){this.wrapper.find(".mabel-mc-chosen").append('<span class="mabel-mc-choice" data-id="'+e+'">'+t+' <span class="mabel-mc-close">&times;</span></span>')},e}();e.ChoicePicker=t}(e.Components||(e.Components={}))}(e.Admin||(e.Admin={}))}(Core||(Core={}));
